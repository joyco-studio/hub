...
This is how I reference documentation when I’m talking to agents: I link the **`.md` version of the page**, not whatever URL I’m currently viewing in the browser.

My standard is: **same path, add `.md`**.

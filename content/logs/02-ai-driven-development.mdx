...
Cursor has a [webapp for cloud agents](https://cursor.com/agents), you can use it kickoff new agents and supervise them. This is pretty useful to trigger small async tasks you want to defer completely.

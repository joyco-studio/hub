...
## The `.md` standard for documentation URLs

This is what I do: when I’m chatting with agents, I **never paste the “pretty website” URL**. I use the `.md` version as a documentation standard, because it’s the cleanest way to attach *real context* to a conversation.

The rule is simple: **same path, add `.md`**.

Why it matters in practice:

- **Agents get source**: markdown content, not a page full of layout/navigation.
- **Links are consistent**: every doc reference looks the same and is easy to generate.
- **Better “context handles”**: I can drop a `.md` link in a prompt and it’s unambiguous that I’m pointing at documentation content.

...
When sharing docs, prefer the **canonical `.md` URL** instead of copy-pasting whatever URL you happen to be on in the browser.

The `.md` suffix is a small convention that makes links:

- **Predictable**: it’s always “the same path, plus `.md`”.
- **Tool-friendly**: agents, scripts, and scrapers can reliably fetch markdown (instead of HTML/navigation chrome).
- **Stable to reference**: the intent is “this is documentation content”, not “this is a routed web page”.

For example, the `.md` URL for this page is:

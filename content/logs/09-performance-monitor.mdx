...
Think of it as a dashboard for the browser's rendering engine. The Performance tab records a trace you analyze later. The Performance **monitor** is a live feed. Use the trace for deep analysis. Use the monitor for ambient awareness.

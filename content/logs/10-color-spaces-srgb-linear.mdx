...
<Image src="https://r2.joyco.studio/Tpo9EPhncb7y.png" alt="sRGB encode/decode curve graphs" width={3600} height={2088} />

<Image src="https://r2.joyco.studio/3sxhhrtTvGDr.png" alt="sRGB encode/decode curve graphs" width={3600} height={2084} />
...
<Image src="https://r2.joyco.studio/VuF7BqOqb6qZ.png" alt="Bake-time diagram (Linear 16-bit/32-bit → sRGB 8-bit)" width={3011} height={1398} />

{/* TODO: upload decode diagram (sRGB 8-bit → Linear 16-bit in WebGL GPU) to R2 and add <Figure> component here */}
<Image src="https://r2.joyco.studio/e5bRUYGlEVvH.png" alt="Decode diagram (sRGB 8-bit → Linear 16-bit in WebGL GPU)" width={3011} height={1398} />
...
<Image src="https://r2.joyco.studio/U7nwGUjoLXPZ.png" alt="Game gamma slider screenshot" width={1920} height={1080} />

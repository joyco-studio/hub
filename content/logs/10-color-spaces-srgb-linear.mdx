...
{/* TODO: upload sRGB encode/decode curve graphs to R2 and add <Figure> components here */}
...
{/* TODO: upload bake-time diagram (Linear 16-bit/32-bit → sRGB 8-bit) to R2 and add <Figure> component here */}
...
{/* TODO: upload decode diagram (sRGB 8-bit → Linear 16-bit in WebGL GPU) to R2 and add <Figure> component here */}
...
{/* TODO: upload game gamma slider screenshot to R2 and add <Figure> component here */}

...
description: Style inner elements from the parent using data-slot attributes instead of multiple className props.
author: 'matiasperz'
---
...
Want cleaner syntax? Check out the [slot variant Tailwind plugin](/toolbox/tailwind#slot-variant-data-slot-targeting) for sugar like `slot-[card-description]:opacity-50`.
